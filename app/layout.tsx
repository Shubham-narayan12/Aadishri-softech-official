...
export const metadata: Metadata = {
  title: "Aadishri Softtech",
  description:
    "Generated by Aadishri Softtech Multi-purpose Bootstrap 5 Next.js Template",
    icons: {
    icon: "/public/Favi.png", // Favicon ka path
  },
};
