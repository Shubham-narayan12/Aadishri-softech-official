              ...
              <div className="row g-md-4 g-3">
                <div className="col-lg-4">
                  ...
                  >
                    <Link
                      href="#"
                      className="p-4 bg-light-2 d-flex gap-3 align-items-center card-contact rounded-3 w-100"
                    >
                      <div>
                      ...
                      <div className="card-contact-content">
                        ...
                        <p className="fw-medium mb-0"  style={{ wordBreak: "break-word", whiteSpace: "normal" }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="card-contact-content">
                        ...
                        <p className="fw-medium mb-0">+919810262354</p>
                      </div>
                    </Link>
                  </div>
                </div>
